...
define ptr @div.3_kernel(ptr %0) #0 {
  ...
  %2 = load float, ptr %arg0, align 4, !invariant.load !3, !noalias !6
  %3 = load float, ptr %arg1, align 4, !invariant.load !3, !noalias !6
  %div.3 = fdiv float %2, %3
  store float %div.3, ptr %arg2, align 4, !alias.scope !6
  br label %return
