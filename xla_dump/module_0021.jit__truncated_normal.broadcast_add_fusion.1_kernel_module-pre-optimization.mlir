module @broadcast_add_fusion.1_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  func.func @broadcast_add_fusion.1(%arg0: tensor<i32> {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, xla.invariant, xla.slice_index = 0 : index}, %arg1: tensor<4xi32> {llvm.align = 64 : index, llvm.dereferenceable = 16 : index, xla.invariant, xla.slice_index = 1 : index}, %arg2: tensor<32x16xi32> {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, xla.invariant, xla.slice_index = 2 : index}, %arg3: tensor<32x16xi32> {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, xla.invariant, xla.slice_index = 3 : index}, %arg4: tensor<32x16xi32> {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, xla.slice_index = 4 : index}) -> tensor<32x16xi32> attributes {xla.backend_kind = #xla.backend_kind<cpu>, xla.entry} {
    %0 = xla.workgroup_id  x {xla.range = [0 : index, 0 : index]}
    %1 = xla.workgroup_id  y {xla.range = [0 : index, 0 : index]}
    %2 = xla.workgroup_id  z {xla.range = [0 : index, 0 : index]}
    %3 = scf.forall (%arg5, %arg6, %arg7) in (1, 1, 1) shared_outs(%arg8 = %arg4) -> (tensor<32x16xi32>) {
      %xla_loop = xla.loop (%arg5, %arg6, %arg7, %0, %1, %2)[%i, %j] -> (%ra, %rb) in #xla.indexing_map<"(th_x, th_y, th_z, bl_x, bl_y, bl_z)[s0, s1] -> (s0, s1), domain: th_x in [0, 0], th_y in [0, 0], th_z in [0, 0], bl_x in [0, 0], bl_y in [0, 0], bl_z in [0, 0], s0 in [0, 31], s1 in [0, 15]"> iter_args(%iter = %arg8) -> (tensor<32x16xi32>) {
        %pure_call = xla.pure_call @fused_computation_1_add_78(%arg0, %arg1, %arg2, %arg3, %ra, %rb) : (tensor<i32>, tensor<4xi32>, tensor<32x16xi32>, tensor<32x16xi32>, index, index) -> i32
        %inserted = tensor.insert %pure_call into %iter[%ra, %rb] : tensor<32x16xi32>
        xla.yield %inserted : tensor<32x16xi32>
      }
      scf.forall.in_parallel {
        tensor.parallel_insert_slice %xla_loop into %arg8[0, 0] [32, 16] [1, 1] : tensor<32x16xi32> into tensor<32x16xi32>
      }
    }
    return %3 : tensor<32x16xi32>
  }
  func.func private @fused_computation_1_add_78(%arg0: tensor<i32>, %arg1: tensor<4xi32>, %arg2: tensor<32x16xi32>, %arg3: tensor<32x16xi32>, %arg4: index {xla.range = [0 : index, 31 : index]}, %arg5: index {xla.range = [0 : index, 15 : index]}) -> i32 attributes {llvm.linkage = #llvm.linkage<internal>} {
    %0 = xla.apply_indexing #xla.indexing_map<"() -> (0)">
    %pure_call = xla.pure_call @fused_computation_1_param_1_11(%arg0, %arg1, %arg2, %arg3, %0) : (tensor<i32>, tensor<4xi32>, tensor<32x16xi32>, tensor<32x16xi32>, index) -> i32
    %c32_i32 = arith.constant 32 : i32
    %1 = arith.subi %c32_i32, %pure_call : i32
    %extracted = tensor.extract %arg2[%arg4, %arg5] : tensor<32x16xi32>
    ...
    %pure_call_3 = xla.pure_call @fused_computation_1_param_1_11(%arg0, %arg1, %arg2, %arg3, %9) : (tensor<i32>, tensor<4xi32>, tensor<32x16xi32>, tensor<32x16xi32>, index) -> i32
    %10 = arith.subi %c32_i32, %pure_call_3 : i32
    %extracted_4 = tensor.extract %arg3[%arg4, %arg5] : tensor<32x16xi32>
    %extracted_5 = tensor.extract %arg2[%arg4, %arg5] : tensor<32x16xi32>
    ...
    %pure_call_10 = xla.pure_call @fused_computation_1_param_1_11(%arg0, %arg1, %arg2, %arg3, %21) : (tensor<i32>, tensor<4xi32>, tensor<32x16xi32>, tensor<32x16xi32>, index) -> i32
  ...
  func.func private @fused_computation_1_param_1_11(%arg0: tensor<i32>, %arg1: tensor<4xi32>, %arg2: tensor<32x16xi32>, %arg3: tensor<32x16xi32>, %arg4: index {xla.range = [0 : index, 3 : index]}) -> i32 attributes {llvm.linkage = #llvm.linkage<internal>, no_compute = true} {
