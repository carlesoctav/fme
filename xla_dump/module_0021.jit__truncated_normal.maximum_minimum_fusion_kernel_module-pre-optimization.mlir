module @maximum_minimum_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  func.func @maximum_minimum_fusion(%arg0: tensor<f32> {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, xla.invariant, xla.slice_index = 0 : index}, %arg1: tensor<f32> {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, xla.invariant, xla.slice_index = 1 : index}, %arg2: tensor<32x16xi32> {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, xla.invariant, xla.slice_index = 2 : index}, %arg3: tensor<32x16xi32> {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, xla.invariant, xla.slice_index = 3 : index}, %arg4: tensor<i32> {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, xla.invariant, xla.slice_index = 4 : index}, %arg5: tensor<i32> {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, xla.invariant, xla.slice_index = 5 : index}, %arg6: tensor<32x16xf32> {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, xla.slice_index = 6 : index}) -> tensor<32x16xf32> attributes {xla.backend_kind = #xla.backend_kind<cpu>, xla.entry} {
    %0 = xla.workgroup_id  x {xla.range = [0 : index, 0 : index]}
    %1 = xla.workgroup_id  y {xla.range = [0 : index, 0 : index]}
    %2 = xla.workgroup_id  z {xla.range = [0 : index, 0 : index]}
    %3 = scf.forall (%arg7, %arg8, %arg9) in (1, 1, 1) shared_outs(%arg10 = %arg6) -> (tensor<32x16xf32>) {
      %xla_loop = xla.loop (%arg7, %arg8, %arg9, %0, %1, %2)[%i, %j] -> (%ra, %rb) in #xla.indexing_map<"(th_x, th_y, th_z, bl_x, bl_y, bl_z)[s0, s1] -> (s0, s1), domain: th_x in [0, 0], th_y in [0, 0], th_z in [0, 0], bl_x in [0, 0], bl_y in [0, 0], bl_z in [0, 0], s0 in [0, 31], s1 in [0, 15]"> iter_args(%iter = %arg10) -> (tensor<32x16xf32>) {
        %pure_call = xla.pure_call @fused_computation_2_min_2(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5, %ra, %rb) : (tensor<f32>, tensor<f32>, tensor<32x16xi32>, tensor<32x16xi32>, tensor<i32>, tensor<i32>, index, index) -> f32
        %inserted = tensor.insert %pure_call into %iter[%ra, %rb] : tensor<32x16xf32>
        xla.yield %inserted : tensor<32x16xf32>
      }
      scf.forall.in_parallel {
        tensor.parallel_insert_slice %xla_loop into %arg10[0, 0] [32, 16] [1, 1] : tensor<32x16xf32> into tensor<32x16xf32>
      }
    }
    return %3 : tensor<32x16xf32>
  }
  func.func private @fused_computation_2_min_2(%arg0: tensor<f32>, %arg1: tensor<f32>, %arg2: tensor<32x16xi32>, %arg3: tensor<32x16xi32>, %arg4: tensor<i32>, %arg5: tensor<i32>, %arg6: index {xla.range = [0 : index, 31 : index]}, %arg7: index {xla.range = [0 : index, 15 : index]}) -> f32 attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    %extracted = tensor.extract %arg2[%arg6, %arg7] : tensor<32x16xi32>
    %extracted_3 = tensor.extract %arg3[%arg6, %arg7] : tensor<32x16xi32>
    ...
    %extracted_18 = tensor.extract %arg2[%arg6, %arg7] : tensor<32x16xi32>
    %extracted_19 = tensor.extract %arg3[%arg6, %arg7] : tensor<32x16xi32>
