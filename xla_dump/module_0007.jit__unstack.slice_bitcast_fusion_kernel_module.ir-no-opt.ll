...
define ptr @slice_bitcast_fusion(ptr %0) #0 {
  ...
  call void @slice_bitcast_fusion_wrapped(ptr %5, ptr %7, i64 %11, i64 %13, i64 %15)
  ret ptr null
}

; Function Attrs: alwaysinline
define internal void @slice_bitcast_fusion_wrapped(ptr noalias align 64 dereferenceable(16) %0, ptr noalias align 64 dereferenceable(8) %1, i64 %2, i64 %3, i64 %4) #1 {
  br label %6
...
9:                                                ; preds = %6
  %10 = add nsw i64 %7, 2
  %11 = getelementptr inbounds [4 x i32], ptr %0, i32 0, i64 %10
  %12 = load i32, ptr %11, align 4, !invariant.load !3, !noalias !6
  %13 = getelementptr inbounds [2 x i32], ptr %1, i32 0, i64 %7
  store i32 %12, ptr %13, align 4, !alias.scope !6
  %14 = add i64 %7, 1
  br label %6
