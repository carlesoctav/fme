...
define ptr @broadcast.0_kernel(ptr %0) #0 {
  %broadcast.0.invar_address.dim.0 = alloca i64, align 8
  ...
  store i64 0, ptr %broadcast.0.invar_address.dim.0, align 4
  br label %broadcast.0.loop_header.dim.0

broadcast.0.loop_header.dim.0:                    ; preds = %broadcast.0.loop_body.dim.0, %1
  %broadcast.0.indvar.dim.0 = load i64, ptr %broadcast.0.invar_address.dim.0, align 4
  %2 = icmp uge i64 %broadcast.0.indvar.dim.0, 16
  br i1 %2, label %broadcast.0.loop_exit.dim.0, label %broadcast.0.loop_body.dim.0

broadcast.0.loop_body.dim.0:                      ; preds = %broadcast.0.loop_header.dim.0
  %3 = load float, ptr %arg0, align 4, !invariant.load !3, !noalias !6
  %4 = getelementptr inbounds [16 x float], ptr %arg1, i64 0, i64 %broadcast.0.indvar.dim.0
  store float %3, ptr %4, align 4, !alias.scope !6
  %invar.inc = add nuw nsw i64 %broadcast.0.indvar.dim.0, 1
  store i64 %invar.inc, ptr %broadcast.0.invar_address.dim.0, align 4
  br label %broadcast.0.loop_header.dim.0

broadcast.0.loop_exit.dim.0:                      ; preds = %broadcast.0.loop_header.dim.0
  br label %return

return:                                           ; preds = %broadcast.0.loop_exit.dim.0
  ret ptr null
}
