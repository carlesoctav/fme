module @broadcast_add_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @broadcast_add_fusion.3_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 8 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 2048 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    ...
    %6 = llvm.getelementptr inbounds %arg0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x i32>
    %7 = llvm.load %6 invariant {noalias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>>, description = "xla.slice_index=1">]} : !llvm.ptr -> i32
    llvm.br ^bb1(%3 : i64)
  ^bb1(%8: i64):  // 2 preds: ^bb0, ^bb5
    %9 = llvm.icmp "slt" %8, %1 : i64
    llvm.cond_br %9, ^bb2, ^bb6
  ^bb2:  // pred: ^bb1
    %10 = llvm.mul %8, %5 {xla.range = [-9223372036854775808 : index, 9223372036854775807 : index]} : i64
    %11 = llvm.mul %8, %0 overflow<nsw> : i64
    llvm.br ^bb3(%3 : i64)
  ^bb3(%12: i64):  // 2 preds: ^bb2, ^bb4
    %13 = llvm.icmp "slt" %12, %0 : i64
    llvm.cond_br %13, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %14 = llvm.add %10, %12 {xla.range = [-9223372036854775808 : index, 9223372036854775807 : index]} : i64
    %15 = llvm.lshr %14, %4 : i64
    %16 = llvm.trunc %15 : i64 to i32
    %17 = llvm.add %16, %7 {xla.range = [-9223372036854775808 : index, 9223372036854775807 : index]} : i32
    %18 = llvm.add %11, %12 overflow<nsw> : i64
    %19 = llvm.getelementptr inbounds %arg1[0, %18] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<512 x i32>
    llvm.store %17, %19 {alias_scopes = [#llvm.alias_scope<id = distinct[0]<>, domain = <id = distinct[1]<>>, description = "xla.slice_index=1">]} : i32, !llvm.ptr
    %20 = llvm.add %12, %2 : i64
    llvm.br ^bb3(%20 : i64)
  ^bb5:  // pred: ^bb3
    %21 = llvm.add %8, %2 : i64
    llvm.br ^bb1(%21 : i64)
