; ModuleID = '__compute_module_xor_xor_fusion_kernel_module'
source_filename = "__compute_module_xor_xor_fusion_kernel_module"
...
define ptr @xor_xor_fusion(ptr %0) #0 {
  ...
  call void @xor_xor_fusion_wrapped(ptr %5, ptr %7, i64 %11, i64 %13, i64 %15)
  ret ptr null
}

; Function Attrs: alwaysinline
define internal void @xor_xor_fusion_wrapped(ptr noalias align 64 dereferenceable(8) %0, ptr noalias align 64 dereferenceable(4) %1, i64 %2, i64 %3, i64 %4) #1 {
  %6 = getelementptr inbounds [2 x i32], ptr %0, i32 0, i32 0
  %7 = load i32, ptr %6, align 4, !invariant.load !3, !noalias !6
  %8 = getelementptr inbounds [2 x i32], ptr %0, i32 0, i32 1
  %9 = load i32, ptr %8, align 4, !invariant.load !3, !noalias !6
  %10 = xor i32 %7, %9
  %11 = xor i32 %10, 466688986
  %12 = getelementptr inbounds [1 x i32], ptr %1, i32 0, i32 0
  store i32 %11, ptr %12, align 4, !alias.scope !6
  ret void
}
