...
define internal void @broadcast_multiply_fusion_wrapped(ptr noalias align 64 dereferenceable(2048) %0, ptr noalias align 64 dereferenceable(4) %1, ptr noalias align 64 dereferenceable(2048) %2, i64 %3, i64 %4, i64 %5) #1 {
  %7 = getelementptr inbounds [1 x float], ptr %1, i32 0, i32 0
  %8 = load float, ptr %7, align 4, !invariant.load !3, !noalias !6
  br label %9
...
17:                                               ; preds = %14
  ...
  %19 = getelementptr inbounds [512 x float], ptr %0, i32 0, i64 %18
  %20 = load float, ptr %19, align 4, !invariant.load !3, !noalias !6
  %21 = fmul float %20, %8
  %22 = getelementptr inbounds [512 x float], ptr %2, i32 0, i64 %18
  store float %21, ptr %22, align 4, !alias.scope !6
  %23 = add i64 %15, 1
  br label %14
