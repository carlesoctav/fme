...
define internal void @broadcast_multiply_fusion_wrapped(ptr noalias align 64 dereferenceable(512) %0, ptr noalias align 64 dereferenceable(4) %1, ptr noalias align 64 dereferenceable(512) %2, i64 %3, i64 %4, i64 %5) #1 {
...
17:                                               ; preds = %14
  ...
  %19 = getelementptr inbounds [128 x float], ptr %0, i32 0, i64 %18
  %20 = load float, ptr %19, align 4, !invariant.load !3, !noalias !6
  %21 = fmul float %20, %8
  %22 = getelementptr inbounds [128 x float], ptr %2, i32 0, i64 %18
