...
vector.ph:                                        ; preds = %1, %vector.ph
  %46 = phi i64 [ 0, %1 ], [ %138, %vector.ph ]
  %47 = shl nuw nsw i64 %46, 3
  %48 = getelementptr inbounds nuw [128 x i32], ptr %8, i64 0, i64 %47
  %wide.load = load <8 x i32>, ptr %48, align 4, !invariant.load !3, !alias.scope !11, !noalias !27
  %49 = getelementptr inbounds nuw [128 x i32], ptr %10, i64 0, i64 %47
  ...
  %137 = getelementptr inbounds nuw [128 x float], ptr %16, i64 0, i64 %47
  store <8 x float> %136, ptr %137, align 4, !alias.scope !29, !noalias !30
  %138 = add nuw nsw i64 %46, 1
  %exitcond2.not = icmp eq i64 %138, 16
