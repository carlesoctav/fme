...
define noalias noundef ptr @broadcast_in_dim.2_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
broadcast_in_dim.2.loop_body.dim.0:
...
!6 = !{i64 128}
!7 = !{!8}
!8 = !{!"result slice: {index:0, offset:0, size:128}", !9}
!9 = !{!"XLA host kernel broadcast_in_dim.2_kernel AA domain"}
