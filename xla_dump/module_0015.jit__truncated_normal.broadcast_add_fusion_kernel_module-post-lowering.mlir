module @broadcast_add_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  llvm.func @broadcast_add_fusion(%arg0: !llvm.ptr) -> !llvm.ptr attributes {frame_pointer = #llvm.framePointerKind<all>, passthrough = [["prefer-vector-width", "256"]], uwtable_kind = #llvm.uwtableKind<async>} {
    ...
    %14 = llvm.load %13 invariant dereferenceable<bytes = 512> : !llvm.ptr -> !llvm.ptr
  ...
  llvm.func internal @broadcast_add_fusion_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 16 : index, llvm.noalias, xla.invariant}, %arg2: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 512 : index, llvm.noalias, xla.invariant}, %arg3: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 512 : index, llvm.noalias, xla.invariant}, %arg4: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, llvm.noalias, xla.invariant}, %arg5: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 512 : index, llvm.noalias}, %arg6: i64, %arg7: i64, %arg8: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %38 = llvm.getelementptr inbounds %arg2[0, %37] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<128 x i32>
    ...
    %44 = llvm.getelementptr inbounds %arg3[0, %37] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<128 x i32>
    ...
    %72 = llvm.getelementptr inbounds %arg5[0, %37] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<128 x i32>
